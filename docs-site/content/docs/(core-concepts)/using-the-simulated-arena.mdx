...
Your robot can interact with these pieces by bumping into them or grabbing them (see [Intake Simulation](/docs/simulating-intake)).
...
<Cards>
  <Card title="Simulating Intake" href="/docs/simulating-intake">
    Game pieces can be collected by intakes once they are added to the field.
  </Card>
  ...
  <Card title="Simulating Opponent Robots" href="/docs/simulating-opponent-robots">
    Add dynamic robots to the field and test interactions.
  </Card>
</Cards>
