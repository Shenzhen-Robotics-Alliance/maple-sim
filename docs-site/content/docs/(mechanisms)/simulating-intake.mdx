...
<div style={{ display: 'flex', gap: '2%' }}>
  <img src="/media/intakesim2.png" alt="Intake simulation 2" style={{ width: '49%' }} />
  <img src="/media/intakesim3.png" alt="Intake simulation 3" style={{ width: '49%' }} />
</div>
...
>
  <Tab value="In-The-Frame (ITF) Intakes">
    <div style={{ display: 'flex', alignItems: 'center' }}>
      <div style={{ alignItems: 'center', width: '29%' }}>
        <img src="/media/intakesim3.png" alt="In-the-frame intake" style={{ maxHeight: '100%', margin: 'auto' }} />
      </div>
  ...
  <Tab value="Over-The-Bumper (OTB) Intakes">
    <div style={{ display: 'flex', alignItems: 'center' }}>
      <div style={{ alignItems: 'center', width: '29%' }}>
        <img src="/media/intakesim2.png" alt="Over-the-bumper intake" style={{ maxHeight: '100%', margin: 'auto' }} />
      </div>
      <div style={{ width: '70%', fontSize: '13px' }}>
        ```java
...
<Callout type="info" title="Tip">
  Use `setCustomIntakeCondition(Predicate<GamePieceOnFieldSimulation>)` to define a custom condition which controls which game pieces can enter the intake. Example usage: if you want your simulated intake to only intake game pieces that are in a specific orientation.
</Callout>
...
<Callout type="info" title="Tip">
  As shown in the code above, you can notify `FlyWheelIOSim` (the simulated flywheel mechanism) to shoot the note out when the note is passed to the shooter from the intake. See [Simulating GamePiece Projectiles](/docs/simulating-projectiles) for more details.
...
<Cards>
  <Card title="Simulating Projectiles" href="/docs/simulating-projectiles">
    Visualize launched game pieces alongside the rest of the simulation.
  </Card>
  <Card title="Simulating Opponent Robots" href="/docs/simulating-opponent-robots">
    Test interactions with dynamic robots on the field.
  </Card>
</Cards>
