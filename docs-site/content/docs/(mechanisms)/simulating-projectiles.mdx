...
The real-time positions of the flying game pieces are also visualized with other game pieces, as described [here](/docs/using-the-simulated-arena#4-visualizing-game-pieces).

## Next steps

<Cards>
  <Card title="Simulated Arena" href="/docs/using-the-simulated-arena">
    Visualize game pieces, field elements, and robots together in the arena.
  </Card>
