...
For an in-depth description of the simulations, please refer to [Simulation Details](/docs/simulation-details).

## Demo Video

<a href="https://www.youtube.com/watch?v=CBx1_Dosgec">
  <img src="/media/demo%20video%20cover.png" alt="Demo Video" />
</a>
...
1. [Installing maple-sim](/docs/installing-maple-sim)
2. [Using the Simulated Arena](/docs/using-the-simulated-arena)
3. [Simulating Swerve Drivetrain](/docs/swerve-simulation-overview)
4. [Simulating Intake](/docs/simulating-intake)
5. [Simulating Projectiles](/docs/simulating-projectiles)
6. [Simulating Opponent Robots](/docs/simulating-opponent-robots)
...
<Callout type="success" title="Contributing">
  For detailed guidelines on contributing to the project, please refer to the [contribution guide](/docs/CONTRIBUTION).
</Callout>
