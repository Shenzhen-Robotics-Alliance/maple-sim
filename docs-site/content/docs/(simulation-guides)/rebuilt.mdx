...
<Callout type="info" title="Detailed Documents on Game Pieces Simulation">
  **[Adding Game Pieces to the Field](/docs/using-the-simulated-arena#3-adding-game-pieces-to-the-field)**

  **[Visualizing Game Pieces](/docs/using-the-simulated-arena#4-visualizing-game-pieces)**
</Callout>
...
<Callout type="info" title="Detailed Documents on IntakeSimulation">
  **[Simulating Intake](/docs/simulating-intake)**
</Callout>
...
See [Simulating Projectiles](/docs/simulating-projectiles).
