...
<Accordions type="single">
  <Accordion title="About this approach">
...
<img src="/media/subsystem%20abstraction.svg" alt="Subsystem abstraction diagram" />
...
To do this, we will use the `SimplifiedSwerveDriveSimulation` class. This class manages and controls a [SwerveDriveSimulation](/docs/swerve-simulation-overview), similar to how your user code controls the physical chassis. Based on the commands sent by the user, it runs closed loops on the virtual drive/steer motors in the simulated drivetrain, mimicking the behavior of the real swerve drive.
