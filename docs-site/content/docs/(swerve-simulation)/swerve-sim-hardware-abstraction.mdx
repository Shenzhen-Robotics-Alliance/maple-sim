...
<img src="/media/hardware%20abstraction.svg" alt="Hardware abstraction diagram" />
...
- `MySubsystemIOSim.java`: The simulation implementation of the IO interface, which runs the physics simulation.
