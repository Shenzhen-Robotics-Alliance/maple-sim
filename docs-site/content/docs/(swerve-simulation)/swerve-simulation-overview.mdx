...
<Cards>
  <Card title="The simple approach" href="/docs/swerve-sim-easy">
  ...
  <Card title="The professional approach" href="/docs/swerve-sim-hardware-abstraction">
...
<Cards>
  <Card title="Simple Swerve Sim" href="/docs/swerve-sim-easy">
    Use the simplified approach embedded in MapleSim for quick iteration.
  </Card>
  <Card title="Hardware Abstraction Sim" href="/docs/swerve-sim-hardware-abstraction">
    Mirror your real robot IO for high-fidelity simulation.
  </Card>
</Cards>
