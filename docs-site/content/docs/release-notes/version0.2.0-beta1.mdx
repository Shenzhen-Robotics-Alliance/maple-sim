...
Check out the [documentation](/docs/swerve-sim-easy) for more details.
...
The online documentation is available [here](/docs/installing-maple-sim).

You can also access the online Javadocs [here](/javadocs/).
...
<Accordions type="single">
  <Accordion title="Contributors and Their Contributions">
    ...
    - [@GearFox](https://github.com/GearBoxFox) from Team 4467 _"Titanium Titans"_, my mentor who guided me to FRC, for:
      - Creating the [Simplified Swerve Simulation](/docs/swerve-sim-easy) in [#25](https://github.com/Shenzhen-Robotics-Alliance/maple-sim/pull/25).
    ...
    - [@KfirNeuman](https://github.com/KfirNeuman) from Team 3075 _"Ha-Dream Team"_ for:
      - Improving the readability of the DRIVE_WHEEL_TYPE enum in [#14](https://github.com/Shenzhen-Robotics-Alliance/maple-sim/pull/14).
...
We warmly invite you to [report bugs, suggest for new features](https://github.com/Shenzhen-Robotics-Alliance/maple-sim/issues/new/choose) and [contribute to the project](/docs/CONTRIBUTION).
