...
Check out the [documentation](/swerve-sim-easy) for more details.
...
The online documentation is available [here](/installing-maple-sim).
...
<Accordions type="single">
  <Accordion title="Contributors and Their Contributions">
    ...
    - [@GearFox](https://github.com/GearBoxFox) from Team 4467 _"Titanium Titans"_, my mentor who guided me to FRC, for:
      - Creating the [Simplified Swerve Simulation](/swerve-sim-easy) in [#25](https://github.com/Shenzhen-Robotics-Alliance/maple-sim/pull/25).
...
We warmly invite you to [report bugs, suggest for new features](https://github.com/Shenzhen-Robotics-Alliance/maple-sim/issues/new/choose) and [contribute to the project](/CONTRIBUTION).
