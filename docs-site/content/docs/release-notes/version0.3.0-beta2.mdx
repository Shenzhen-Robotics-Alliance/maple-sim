...
- #### New AdvantageKit Swerve Templates
  ...
  In the **[Kick-Off Release of AdvantageKit (V4.0.0)](https://github.com/Mechanical-Advantage/AdvantageKit/releases/tag/v4.0.0)**, the AdvantageKit Swerve Templates have received several upgrades. We will be integrating these upgrades into **[our modified version of AdvantageKit Swerve Templates with Maple-Sim integration](/#getting-started-with-templates)** so that teams can easily use them for the new season.
