...
The real-time positions of the flying game pieces are also visualized with other game pieces, as described [here](/using-the-simulated-arena#4-visualizing-game-pieces).
