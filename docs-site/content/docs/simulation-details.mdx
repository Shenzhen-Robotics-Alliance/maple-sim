...
![swerve drive dynamics.gif](/media/swerve%20drive%20dynamics.gif)

The realistic simulation dynamics allow you to test and refine auto paths as they would perform in real-world conditions.

![path following simulation.gif](/media/path%20following%20simulation.gif)

**[View Full Document on Swerve Simulation](/docs/swerve-simulation-overview)**
...
![vision simulation.gif](/media/vision%20simulation.gif)
...
![game pieces simulation.gif](/media/game%20pieces%20simulation.gif)

![intakesim.gif](/media/intakesim.gif)

**[View Full Document on Intake Simulation](/docs/simulating-intake)**
...
![projectile simulation.gif](/media/projectile%20simulation.gif)

**[View Full Document on Projectile Simulation](/docs/simulating-projectiles)**
