 ...
 */
public abstract class DriveTrainSimulation extends Body {
     ...
     */
    protected DriveTrainSimulation(DriveTrainSimulationConfig<?, ?> config, Pose2d initialPoseOnField) {
     ...
     *
     * <p>It is implemented in the sub-classes of {@link DriveTrainSimulation}.
     *
    ...
    public Pose3d getSimulatedPose3d() {
        return new Pose3d(GeometryConvertor.toWpilibPose2d(getTransform()));
    }
    ...
    public DriveTrainSimulationConfig<?, ?> getConfig() {
        return config;
    }
    ...
    public static <T extends DriveTrainSimulation, C extends DriveTrainSimulationConfig<T, C>> T createDriveTrainSimulation(SimRobot robot, C config, Pose2d initialPoseOnField) {
        if (config instanceof SwerveConfig) {
            return (T) new SwerveDriveSimulation(robot, (SwerveConfig) config, initialPoseOnField);
        }
