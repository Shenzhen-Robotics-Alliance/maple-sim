 ...
 *       SwerveModuleSimulation#updateSimulationSubTickGetModuleForce(Vector2, Rotation2d, Force)}.
...
public class SwerveDriveSimulation extends AbstractDriveTrainSimulation {
   ...
   * @param bumperWidth the width of the robot's bumpers
   * @param bumperLength the length of the robot's bumpers
    ...
    super(
        new DriveTrainSimulationProfile(
                ...
                moduleSimulations[0].getModuleMaxAccelerationMPSsq(
                    robotMassWithBumpers, moduleSimulations.length),
   ...
   *
   * @param robotMassWidthBumpers the total mass of the robot including bumpers
   * @param trackWidth the width of the robot's track
   * @param trackLength the length of the robot's track
   * @param bumperWidth the width of the robot's bumpers
   * @param bumperLength the length of the robot's bumpers
  ...
  public SwerveDriveSimulation(
    ...
    this(
        ...
        new Translation2d[] {
          new Translation2d(trackLength.divide(2), trackWidth.divide(2)),
          new Translation2d(trackLength.divide(2), trackWidth.divide(-2)),
          new Translation2d(trackLength.divide(-2), trackWidth.divide(2)),
          new Translation2d(trackLength.divide(-2), trackWidth.divide(-2))
        },
