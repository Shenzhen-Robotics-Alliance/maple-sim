 ...
 *
 * <p>This class contains basic functions all game pieces will have so that game pieces of different types can be used interchangeably in collision detection.
 */
