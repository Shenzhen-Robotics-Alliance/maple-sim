 ...
 *
 * <p>This class simulates a game piece on the field, which has a collision space and interacts with other objects.</p>
 * <p>Game pieces can be "grabbed" by an {@link IntakeSimulation}.</p>
 * <p>For the simulation to actually run, every instance must be added to a {@link org.ironmaple.simulation.SimulatedArena} through {@link SimulatedArena#addGamePiece(GamePieceOnFieldSimulation)}.</p>
 * */
public class GamePieceOnFieldSimulation extends Body {
     ...
     *
     * <p>Normally, the height is fixed at half the thickness of the game piece to simulate it being "on the ground."</p>
     * <p>If the game piece is flying at a low height, the height is calculated using the law of free-fall.</p>
     */
    private final DoubleSupplier zPositionSupplier;
    /**
     * <h2>The Type of the Game Piece.</h2>
     *
     * <p>Affects the result of {@link SimulatedArena#getGamePiecesByType(String)}.</p>
     */
     ...
     * */
    public GamePieceOnFieldSimulation(String type, Convex shape, DoubleSupplier zPositionSupplier, double mass, Translation2d initialPosition, Translation2d initialVelocityMPS) {
        super();
        this.type = type;
     ...
     *
     * <p>The 3d position is calculated from both the {@link #getPoseOnField()} and {@link #zPositionSupplier}</p>
     *
