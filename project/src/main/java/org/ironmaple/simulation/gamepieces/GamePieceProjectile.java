...
public class GamePieceProjectile {
  ...
  public void addGamePieceAfterTouchGround(SimulatedArena simulatedArena) {
    ...
    simulatedArena.addGamePiece(
        new GamePieceOnFieldSimulation(
            gamePieceType,
            shape,
            () -> Math.max(gamePieceHeight / 2, getPositionAtTime(launchedTimer.get()).getZ()),
            massKg,
   ...
   *
   * <p>Reverts the effect of {@link #enableBecomesGamePieceOnFieldAfterTouchGround(Convex, double,
   * double)}.
   */
