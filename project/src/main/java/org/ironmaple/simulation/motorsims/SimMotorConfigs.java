...
public final class SimMotorConfigs {
     ...
     *
     * <p>This method configures a PD controller for handling positional requests with voltage commands. The controller
     * is unit-safe and can be used with {@link ControlRequest.PositionVoltage} to control motor position.
     *
     ...
     * </code></pre>
     *
     * <p>The proportional gain (`kP`) and derivative gain (`kD`) are both configured in terms of voltage per unit of
     * error and velocity, ensuring unit consistency.
     *
     ...
     *
     * <p>This method configures a PD controller to handle velocity requests using voltage commands. It ensures unit
     * consistency and allows voltage requests for controlling motor velocity.
     *
     ...
     * </code></pre>
     *
     * <p>The proportional gain (`kP`) is configured in terms of voltage per unit of angular velocity, which determines
     * the motor's response to the velocity error.
     *
     * @param kP the proportional gain
     * @return this instance for method chaining
     */
     ...
     *
     * <p>This method configures a PD controller to handle positional requests using current commands. It ensures unit
     * consistency and allows current-based positional control for the motor.
     *
     * <p>For example, it can be configured as follows:
     *
     * <pre><code>
     ...
     * </code></pre>
     *
     * <p>The proportional gain (`kP`) and derivative gain (`kD`) are configured in terms of current per unit of angle
     * and current per unit of angular velocity, which determines the motor's response to the positional error and the
     * rate of change of that error.
     *
     ...
     *
     * <p>This method configures a PD controller to handle velocity requests with current commands. It ensures unit
     * consistency and allows current-based velocity control for the motor.
     *
     * <p>For example, it can be configured as follows:
     *
     * <pre><code>
     ...
     * </code></pre>
     *
     * <p>The proportional gain (`kP`) is defined in terms of current per unit of angular velocity, which determines the
     * motor's response to the velocity error.
     *
