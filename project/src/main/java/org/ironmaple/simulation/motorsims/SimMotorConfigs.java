...
public final class SimMotorConfigs {
     ...
     * @param motorVelocity the un-geared angular velocity of the motor
     * @return the voltage required for the motor to achieve the specified current and angular velocity
     */
    public Voltage calculateVoltage(Current current, AngularVelocity motorVelocity) {
        return Volts.of(motor.getVoltage(current.in(Amps), motorVelocity.in(RadiansPerSecond) * gearing));
    }
     ...
     */
    public Current calculateCurrent(AngularVelocity motorVelocity, Voltage voltage) {
        return Amps.of(motor.getCurrent(motorVelocity.in(RadiansPerSecond), voltage.in(Volts)));
    }
     ...
     * @param torque the torque generated by the motor.
