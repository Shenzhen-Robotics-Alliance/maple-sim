 ...
 *
 * <p>This class cannot be instantiated directly; it must be created as a specific season's arena.</p>
 * <p>The default instance can be obtained using the {@link #getInstance()} method.</p>
 * <p>Simulates all interactions within the arena field.</p>
 *
 * <h2>The following objects can be added to the simulation world and will interact with each other:</h2>
 * <ul>
 *   <li>{@link AbstractDriveTrainSimulation}: Represents abstract drivetrain simulations with collision detection.</li>
 *   <li>{@link GamePieceOnFieldSimulation}: Represents abstract game pieces with collision detection.</li>
 *   <li>{@link IntakeSimulation}: Represents an intake simulation that responds to contact with {@link GamePieceOnFieldSimulation}.</li>
 * </ul>
 */
public abstract class SimulatedArena {
     ...
     * <p>Multiple instances of {@link SimulatedArena} can exist elsewhere.</p>
     *
     ...
     * <p>Overrides the return value of {@link #getInstance()}</p>
     * <p>This method allows simulating an arena from a different year or a custom field.</p>
     * <p>Currently, only the 2024 arena is supported, so avoid calling this method for now.</p>
     *
     ...
     * <h4>If Using <a href='https://github.com/Mechanical-Advantage/AdvantageKit'>Advantage-Kit</a>: DO NOT CHANGE THE DEFAULT TIMINGS</h4>
     *
     * <p>Changes apply to every instance of {@link SimulatedArena}.</p>
     * <p>The new configuration will take effect the next time {@link SimulatedArena#simulationPeriodic()} is called on an instance.</p>
     * <p>It is recommended to call this method before the first call to {@link SimulatedArena#simulationPeriodic()} of any instance.</p>
     * <p>It is also recommended to keep the simulation frequency above 200 Hz for accurate simulation results.</p>
     *
     * @param robotPeriodSeconds the time between two calls of {@link #simulationPeriodic()}, usually obtained from {@link TimedRobot#getPeriod()}
     * @param simulationSubTicksPerPeriod the number of Iterations, or {@link #simulationSubTick()} that the simulation runs per each call to {@link #simulationPeriodic()}
     */
     ...
     *
     * <p>This constructor initializes a physics world with zero gravity and adds the provided obstacles to the world.</p>
     * <p>It also sets up the collections for drivetrain simulations, game pieces, projectiles, and intake simulations.</p>
     *
     ...
     *
     * <p><strong>FOR TESTING ONLY: This method will be removed in the final release.</strong></p>
     *
     ...
     *
     * <p><strong>NOTE:</strong> This method is automatically called in the constructor of {@link IntakeSimulation}, so you don't need to call it manually.</p>
     * <p>The intake simulation should be bound to an {@link AbstractDriveTrainSimulation} and becomes part of its collision space.</p>
     * <p>This method immediately starts the {@link org.ironmaple.simulation.IntakeSimulation.GamePieceContactListener}, which listens for contact between the intake and any game piece.</p>
     *
     ...
     *
     * <p>The collision space of the drive train is immediately added to the simulation world.</p>
     * <p>Starting from the next call to {@link #simulationPeriodic()}, the {@link AbstractDriveTrainSimulation#simulationSubTick()} method will be called during each sub-tick of the simulator.</p>
     *
     ...
     *
     * <p>The collision space of the game piece is immediately added to the simulation world.</p>
     * <p>{@link IntakeSimulation}s will be able to interact with this game piece during the next call to {@link SimulatedArena#simulationPeriodic()}.</p>
     *
     ...
     *
     * <p>Calls to {@link GamePieceProjectile#launch()}, which will launch the game piece immediately.</p>
     *
     ...
     *
     * <p>Removes the game piece from the physics world and the simulation's game piece collection.</p>
     *
     ...
     *
     * <p>This method clears all game pieces from the physics world and the simulation's game piece collection.</p>
     */
     ...
     * <p>This method should be called ONCE in {@link TimedRobot#simulationPeriodic()}
     * (or <code>LoggedRobot.simulationPeriodic()</code> if using <a href='https://github.com/Mechanical-Advantage/AdvantageKit'>Advantage-Kit</a>)</p>
     * <p>If not configured through {@link SimulatedArena#overrideSimulationTimings(double robotPeriodSeconds, int simulationSubTicksPerPeriod)}, the simulator will iterate through 5 Sub-ticks by default.</p>
     * <p>The amount of CPU Time that the Dyn4j engine uses in displayed in <code>SmartDashboard/MapleArenaSimulation/Dyn4jEngineCPUTimeMS</code>, usually performance is not a concern</p>
     * */
     ...
     *
     * <p>This method performs the actions for each sub-tick of the simulation, including:</p>
     * <ul>
     *   <li>Updating all registered {@link AbstractDriveTrainSimulation} objects.</li>
     *   <li>Updating all {@link GamePieceProjectile} objects in the simulation.</li>
     *   <li>Stepping the physics world with the specified sub-tick duration.</li>
     *   <li>Removing any game pieces as detected by the {@link IntakeSimulation} objects.</li>
     *   <li>Executing any additional sub-tick actions registered via {@link SimulatedArena#addSimulationSubTickAction(Runnable)}.</li>
     * </ul>
     */
     ...
     *
     * <p>This method is used to visualize the positions of game pieces</p>
     * <p>Also, if you have a game-piece detection vision system <strong>(wow!)</strong>, this is the how you can simulate it.</p>
     * <p>Both {@link GamePieceOnFieldSimulation} and {@link GamePieceProjectile} of the specified type will be included.</p>
     *
     * <ul>
     *   <li>The type is determined in the constructor of {@link GamePieceOnFieldSimulation}.</li>
     *   <li>For example, {@link org.ironmaple.simulation.seasonspecific.crescendo2024.CrescendoNoteOnField} has the type "Note".</li>
     * </ul>
     *
     ...
     *
     * <p>This method clears all current game pieces from the field and places new game pieces in their starting positions for the autonomous mode.</p>
     */
     ...
     *
     * <p>This method sets up the game pieces on the field, typically in their starting positions for autonomous mode.</p>
     * <p>It should be implemented differently for each season-specific subclass of {@link SimulatedArena} to reflect the unique game piece placements for that season's game.</p>
     */
     ...
     *
     * <p>This method defines season-specific tasks to be executed during the {@link SimulatedArena#simulationPeriodic()} method.</p>
     * <p>For example:</p>
     * <ul>
     *   <li>Updating the score counts.</li>
     *   <li>Simulating human player activities.</li>
     * </ul>
     * <p>This method should be implemented in the season-specific subclass of {@link SimulatedArena} to reflect the unique aspects of that season's game.</p>
     */
     ...
     * <p>Stores the layout of obstacles and game pieces.</p>
     * <p>For each season-specific subclass of {@link SimulatedArena}, there should be a corresponding subclass of this class to store the field map for that specific season's game.</p>
     */
    public static abstract class FieldMap {
