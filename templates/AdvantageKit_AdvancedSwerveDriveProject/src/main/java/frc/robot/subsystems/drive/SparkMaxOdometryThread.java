 ...
 *
 * <p>This version is intended for devices like the SparkMax that require polling rather than a blocking thread. A
 * Notifier thread is used to gather samples with consistent timing.
 */
