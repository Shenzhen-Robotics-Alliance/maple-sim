 ...
 * <p>For the simulation to actually run, every instance must be added to a {@link SimulatedArena} through {@link SimulatedArena#addGamePiece(GamePieceOnFieldSimulation)}.</p>
 * */
